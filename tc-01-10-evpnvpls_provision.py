...
#    print(service_r1.to_alu_r13_xml())
...
#    print(service_r3.to_alu_r13_xml())
#    print(to_xml(service_r1.to_alu_r13_xml()))
    ...
    print(str(datetime.now().time()) + " Begin of R1 vpls provision")
    conn_r1.load_configuration(config=service_r1.to_alu_r13_xml(), format='xml')
    print(str(datetime.now().time()) + " End of R1 vpls provision")

    print()

    print(str(datetime.now().time()) + " Begin of R3 vpls provision")
    conn_r3.load_configuration(config=service_r3.to_alu_r13_xml(), format='xml')
    print(str(datetime.now().time()) + " End of R3 vpls provision")
