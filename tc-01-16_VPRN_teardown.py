...
if __name__ == '__main__':
    ...
    print(str(datetime.now().time()) + " Begin of R1 vprn teardown")
    conn_r1.load_configuration(config=service_r1.to_teardown_cli(), format='cli')
    print(str(datetime.now().time()) + " End of R1 vprn teardown")

    print(str(datetime.now().time()) + " Begin of R3 vprn teardown")
    conn_r3.load_configuration(config=service_r3.to_teardown_cli(), format='cli')
    print(str(datetime.now().time()) + " End of R3 vprn teardown")
