...
#    print(service_r1.to_teardown_cli())
...
#    print(to_xml(service_r3.to_alu_r13_xml()))
    ...
    print(str(datetime.now().time()) + " Begin of R1 vpws teardown")
    conn_r1.load_configuration(config=service_r1.to_teardown_cli(), format='cli')
    print(str(datetime.now().time()) + " End of R1 vpws teardown")

    print()

    print(str(datetime.now().time()) + " Begin of R3 vpws teardown")
    conn_r3.load_configuration(config=service_r3.to_teardown_cli(), format='cli')
    print(str(datetime.now().time()) + " End of R3 vpws teardown")
